...
mod tests {
    ...
    use contracts::{
        ...
        EvidenceManifestV1, ExecutiveBriefV1, FxDriverAssessmentV1, GlobalLiquidityPhaseV1,
        KnowledgeAppendixV1, KnowledgeCapsuleV1, KnowledgeDocumentFormatV1, KnowledgeEdgeV1,
        KnowledgeRelationshipV1, KnowledgeSourceKindV1, KnowledgeSourceV1,
        MacroFinancialAnalysisV1, MechanismMapV1, ProbabilityV1, RankedRiskV1, RiskRegisterEntryV1,
        ScenarioCaseV1, ScenarioKindV1, SignalMagnitudeV1, SignalSummaryEntryV1,
