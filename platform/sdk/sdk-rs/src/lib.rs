...
pub enum PlatformCommandV1 {
    ...
    SubmitMacroFinancialAnalysis(Box<MacroFinancialAnalysisRequestV1>),
}
...
mod tests {
    ...
    use contracts::{
        ...
        ExternalAccountsBalanceSheetMapV1, FxDriverAssessmentV1,
        GlobalLiquidityFundingConditionsV1, GlobalLiquidityPhaseV1, InferenceStepV1,
        KnowledgeAppendixV1, KnowledgeEvidenceUseV1, KnowledgePublicationStatusV1,
        KnowledgeSourceProvenanceV1, MechanismMapV1, PipelineStepIdV1, PipelineStepTraceV1,
